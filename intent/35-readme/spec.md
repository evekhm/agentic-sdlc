...
- `README.md` exists at the repository root; every `## ` heading
  ...
  2026-09-03).
- Every fenced block except the command block is a `text` diagram and
  no section carries more than one (D4, cap lifted 2026-09-09; the
  line and section-length caps were lifted 2026-09-03).
...
- Exactly one fenced command block exists and its only line is
  `/work <n>`; every other fenced block is a D4 diagram; no fenced
  block contains `scripts/ops/work.sh` (D5).
