...
> [!NOTE]
> **Amended by #269:** Decision D2 is amended by issue #269 (`intent/269-session-spend-sh-prices-gemini-flash/spec.md`) to price Gemini Flash 3.x models at $0.75 base input, $0.00 cache write, $0.075 cache read, and $3.75 output per million tokens, and Gemini Pro 3.1 at $2.00 base input, $0.00 cache write, $0.20 cache read, and $12.00 output per million tokens, aligning with published Google Cloud platform pricing and README.md Section 5.
