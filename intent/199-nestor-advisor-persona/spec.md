...
- AT-10 One advisor session, opened per D15 from the compiled brief
  ...
  `~/persona-advisor.txt`**.
- AT-11 After AT-10 passes, the operator deletes `~/persona-advisor.txt`
...
2. **Deleting `~/persona-advisor.txt`** once AT-10 passes (AT-11).
