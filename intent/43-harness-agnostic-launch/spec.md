...
(PR #60, finding F5); D11, D15, D16, D23 and the "What is being
built" block follow it.
...
open item (b)).** The three paths below the blank line were added
after approval; the list above the blank line is the original. PR #60
